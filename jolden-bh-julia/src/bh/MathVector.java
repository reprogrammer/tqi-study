...
public class MathVector implements Cloneable {
   ...
   **/
  public final static @SuppressWarnings({"rawness","nullness"}) int NDIM = 3;
  /**
   ...
   **/
  @SuppressWarnings({"rawness","nullness"})
  public final void multScalar(@Raw MathVector this, @Nullable @Raw MathVector u, double s) {
    for (int i = 0; i < NDIM; i++) {
      data[i] = u.data[i] * s;
    }
  }
  ...
  @SuppressWarnings({"rawness","nullness"})
  public final void crossProduct(@Raw MathVector this, @Nullable @Raw MathVector u, @Nullable @Raw MathVector w) {
